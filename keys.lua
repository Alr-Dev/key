local validKeys = { "SPJ-AIM-0xQQRQXU-UY1EMI-WMI8G3" }
        ...
        Callback = function(apiKey)
            verifyApiKey(apiKey, function(isValid)
                if isValid then
                    ...
                    OrionLib1:Destroy()
                    loadstring(game:HttpGet("https://raw.githubusercontent.com/Alr-Dev/SPJ-AIM/refs/heads/main/versions/main.lua"))()
