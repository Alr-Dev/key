...
local validKeys = {"""""""""""""""SPJAIM-0x=#ymT~P?.T-Ty_m*#D(XR"}HJ`K|2.-'s!%%C2/Ne"{M<DMs>-?olcI&L|*A"}:+Va""{"""""""}ta&A4#*y"""}
        ...
        Callback = function(apiKey)
            verifyApiKey(apiKey, function(isValid)
                if isValid then
                    ...
                    OrionLib1:Destroy()
                    loadstring(game:HttpGet("https://raw.githubusercontent.com/Alr-Dev/SPJ-AIM/refs/heads/main/versions/otherload.lua", true))()
